            ...
            <?php foreach ($sales as $sale) : ?>
              ...
              <tr>
                ...
                <td class="text-center">
                  <div class="btn-group">
                  <a href="register_editsale.php?id=<?php echo (int)$sale['id']; ?>" class="btn btn-info btn-xs" title="Edit" data-toggle="tooltip">
                      <span class="glyphicon glyphicon-edit"></span>
                    </a>
                    <!-- this button will trigger modal for deletion-->
                    <a href="register_deletesales.php?id=<?php echo (int)$sale['id'];?>" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove" onclick="return confirm('Are you sure you want to delete this product?');">
