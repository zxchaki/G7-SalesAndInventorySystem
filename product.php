          ...
          <tbody>
            ...
            <?php foreach ($products as $product) : ?>
              ...
              <tr <?php echo ($product['quantity'] < 10) ? 'class="low-stock-alert"' : ''; ?>>
                ...
                <td class="text-center">
                  <div class="btn-group">
                    <a href="register_editproduct.php?id=<?php echo (int)$product['id']; ?>" class="btn btn-info btn-xs" title="Edit" data-toggle="tooltip">
                      <span class="glyphicon glyphicon-edit"></span>
                    </a>
                    <!-- this button will trigger modal for deletion-->
                    <a href="register_deleteproduct.php?id=<?php echo (int)$product['id'];?>" class="btn btn-xs btn-danger" data-toggle="tooltip" title="Remove" onclick="return confirm('Are you sure you want to delete this product?');">
